      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 pt-12 lg:pt-20 w-full">
        <div className="mb-12 max-w-md">
          <div className="flex justify-between items-end mb-3">
            <span className="text-xs font-bold tracking-widest text-[#0a29cd] uppercase">Paso 03 de 04</span>
            <span className="text-2xl font-black text-[#0a29cd]">75%</span>
          </div>
          <div className="h-3 w-full bg-[#ccccd6] rounded-full overflow-hidden">
            <div className="h-full w-3/4 bg-gradient-to-r from-[#49c7fd] to-[#0a29cd] rounded-full shadow-[0_0_12px_rgba(0,81,73,0.3)]" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-[#f6f5fa] rounded-[2.5rem] p-8 lg:p-12 shadow-[0_12px_32px_rgba(25,28,33,0.04)]">
            ...
            <div className="space-y-4 mb-8">
              ...
              <label className={`flex items-center p-5 bg-white/50 rounded-2xl cursor-pointer ${onco.desea === false ? 'bg-white ring-2 ring-[#666685]' : 'hover:shadow-sm'}`}>
                <input
                  type="radio"
                  name="affiliation"
