      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 pt-12 lg:pt-20 w-full">
        <div className="mb-12 max-w-md">
          <div className="flex justify-between items-end mb-3">
            <span className="text-xs font-bold tracking-widest text-[#00478d] uppercase">Paso 03 de 05</span>
            <span className="text-2xl font-black text-[#00478d]">55%</span>
          </div>
          <div className="h-3 w-full bg-[#e1e2ea] rounded-full overflow-hidden">
            <div className="h-full w-[55%] bg-gradient-to-r from-[#40dccb] to-[#005149] rounded-full shadow-[0_0_12px_rgba(0,81,73,0.3)]" />
          </div>
        </div>
          ...
          <div className="lg:col-span-7 bg-[#f2f3fb] rounded-[2.5rem] p-8 lg:p-12 shadow-[0_12px_32px_rgba(25,28,33,0.04)]">
            <div className="mb-10">
              ...
              <div className="space-y-4">
                ...
                <label className={`flex items-center p-5 bg-white/50 rounded-2xl cursor-pointer transition-shadow ${onco.desea === false ? 'bg-white ring-2 ring-[#424752]' : 'hover:shadow-sm'}`}>
                  <input
                    type="radio"
                    name="affiliation"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      value={onco.nombres}
                      onChange={(e) => setOncosalud({ nombres: e.target.value })}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      value={onco.dni}
                      onChange={(e) => setOncosalud({ dni: e.target.value })}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      type="tel"
                      value={onco.celular}
                      onChange={(e) => setOncosalud({ celular: e.target.value })}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="email"
                      value={onco.correo}
                      onChange={(e) => setOncosalud({ correo: e.target.value })}
                ...
                <div className="pt-2">
                  <div className="flex items-start gap-4 p-4 bg-[#005149]/5 rounded-2xl border-l-4 border-[#005149]">
                    ...
                    <p className="text-sm text-[#424752] italic">
                      Al completar estos datos, autorizas el descuento correspondiente en tu planilla mensual según el plan seleccionado.
                    </p>
                  </div>
                </div>
              </div>
