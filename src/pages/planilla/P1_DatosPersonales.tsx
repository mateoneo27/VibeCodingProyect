        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-8">
              <p className="text-[#666685] leading-relaxed text-lg mb-4">
                Para comenzar tu vinculación con{' '}
                <span className="font-bold text-[#0a29cd]">Neo</span>, necesitamos validar tu identidad
                y datos de contacto oficiales. Esta información es estrictamente confidencial.
              </p>
              ...
              <div className="bg-[#f6f5fa] p-6 rounded-xl flex gap-4 items-start">
                ...
                <div>
                  <p className="font-bold text-[#000033] text-sm">Seguridad biométrica</p>
                  <p className="text-xs text-[#666685]">Tus datos están protegidos por encriptación de grado bancario.</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#ccccd6] border-none rounded-xl px-4 py-4 focus:ring-2 focus:ring-[#0a29cd] focus:bg-white transition-all outline-none placeholder:text-[#9999ad]/50"
                      required
                    />
                  </div>
