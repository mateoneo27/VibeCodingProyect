        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-8">
              <p className="text-[#424752] leading-relaxed text-lg mb-4">
                Para comenzar tu vinculación con{' '}
                <span className="font-bold text-[#00478d]">Neo</span>, necesitamos validar tu identidad
              ...
              <div className="bg-[#f2f3fb] p-6 rounded-xl flex gap-4 items-start">
                ...
                <div>
                  <p className="font-bold text-[#191c21] text-sm">Seguridad biométrica</p>
                  <p className="text-xs text-[#424752]">Tus datos están protegidos por encriptación de grado bancario.</p>
                </div>
              </div>
            </div>
          </div>
